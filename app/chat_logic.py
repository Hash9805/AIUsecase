...
from config import LLM_MODEL, MAX_CONVERSATION_HISTORY
    ...
    def generate_response(
        ...
        try:
            ...
            if system_prompt:
                ...
                default_system = """You are a helpful and friendly salon booking assistant. 
Your role is to help customers book appointments and answer questions about salon services.
Be warm, professional, and concise. Keep responses friendly but brief."""
